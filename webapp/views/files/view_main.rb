...
module MojuraWebApp
	...
	class FilesView < BaseView
		...
		def initialize(options = {})
			...
			data[:files] ||= []
			@data[:files].map! { |item|
				item[:api_url].gsub!(/files/, '__api__/files')
				item[:file_url].gsub!(/files/, '__api__/files')
				item[:thumb_url].gsub!(/files/, '__api__/files') if (item.include?(:thumb_url))
			...
			@modals = [{id: 'modalAddFile', btn_class: 'btn-primary', btn_title: WebApp.app_str('system', 'action_add'), title: WebApp.app_str('files', 'action_add_file')},
			           {id: 'modalEditFile', btn_class: 'btn-primary', btn_title: WebApp.app_str('system', 'action_edit'), title: WebApp.app_str('files', 'action_edit_file')},
			           {id: 'modalExtractFile', btn_class: 'btn-primary', btn_title: WebApp.app_str('files', 'action_extract'), title: WebApp.app_str('files', 'action_extract_file')},
			           {id: 'modalDeleteFile', btn_class: 'btn-danger', btn_title: WebApp.app_str('system', 'action_delete'), title: WebApp.app_str('files', 'action_delete_file')},
			           {id: 'modalAddFolder', btn_class: 'btn-primary', btn_title: WebApp.app_str('system', 'action_add'), title: WebApp.app_str('files', 'action_add_folder')},
			           {id: 'modalEditFolder', btn_class: 'btn-primary', btn_title: WebApp.app_str('system', 'action_edit'), title: WebApp.app_str('files', 'action_edit_folder')},
			           {id: 'modalDeleteFolder', btn_class: 'btn-danger', btn_title: WebApp.app_str('system', 'action_delete'), title: WebApp.app_str('files', 'action_delete_folder')}]
