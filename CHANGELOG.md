...
##Version 0.16.0
- Removes xml-simple and sanitize, because of server problems.
...
##Version 0.14.3
- Updates the view Maps: Adds JS method to get the Map object, based on the mapID. 
...
##Version 0.13.1
- Fixes bugs in News resource and view.

##Version 0.13.0
- Adds support for categories in the News view
- Fixes reloading-bug when editing views.
