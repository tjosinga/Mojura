...
var TextEditor = (function($) {
	...
	var newVar = {
		"h1": {"icon": "fa-header mojura-h1", "method": function (text, os) { return executeActionSimple("h1", text, os); }},
		"h2": {"icon": "fa-header mojura-h2", "method": function (text, os) { return executeActionSimple("h2", text, os); }},
		"h3": {"icon": "fa-header mojura-h3", "method": function (text, os) { return executeActionSimple("h3", text, os); }},
		"h4": {"icon": "fa-header mojura-h4", "method": function (text, os) { return executeActionSimple("h4", text, os); }},
		"h5": {"icon": "fa-header mojura-h5", "method": function (text, os) { return executeActionSimple("h5", text, os); }},
		"divider 1": "divider",
