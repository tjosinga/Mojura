...
var AdvancedSettings = (function($) {
	...
	function showEdit(id) {
		var obj = $("#settings_row_" + id);
		$(".advanced_setting_value, .settings_edit_btn, .settings_delete_btn", obj).addClass("hidden");
		$(".advanced_setting_input, .advanced_setting_input, .settings_save_btn, .settings_cancel_btn", obj).removeClass("hidden");
		$("input, select", "#settings_row_" + id).val($(".advanced_setting_value", obj).html());
	}

	function hideEdit(id) {
		$(".advanced_setting_input, .advanced_setting_input, .settings_save_btn, .settings_cancel_btn", "#settings_row_" + id).addClass("hidden");
		$(".advanced_setting_value, .settings_edit_btn, .settings_delete_btn", "#settings_row_" + id).removeClass("hidden");
	}
