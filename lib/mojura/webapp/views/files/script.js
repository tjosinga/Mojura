...
var FilesView = (function ($) {
	...
	function refresh() {
		...
		$.getJSON(url, function (data) {
			...
			data.is_root_folder = (!data.id) || (data.id === settings.root_folderid);
			window.console.log("Root folderid: " +  settings.root_folderid);
			data.has_other_root_folder = (settings.root_folderid !== undefined) && (settings.root_folderid !== "");
