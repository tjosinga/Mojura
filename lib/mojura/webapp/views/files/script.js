...
var FilesView = (function ($) {
	...
	function addFile() {
		addEditFile("put", currentFolderId);
	}

	function editFile(fileid) {
		addEditFile("post", fileid);
	}

	function addEditFile(method, id) {
		var titleId = (method === "put") ? "action_add_file" : "action_edit_file";
		Modal.create({
	...
	function addFolder() {
		addEditFolder("put", currentFolderId);
	}

	function editFolder(folderid) {
		addEditFolder("post", folderid);
	}

	function addEditFolder(method, id) {
		var titleId = (method === "put") ? "action_add_folder" : "action_edit_folder";
		Modal.create({
			title: Locale.str("files", titleId),
			oncreated: function(modalId) {
