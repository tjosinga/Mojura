  ...
  class App
    ...
    def call(env)
      ...
      request = Rack::Request.new(env)
   		return [404, {}, []] if (request.params['static_only'] == 'true')
      ...
      if env['is_api_call']
        begin
          ...
          error[:modules] = MojuraAPI::API.modules if (MojuraAPI::API.settings[:developing])
          error[:backtrace] = [e.backtrace] if (MojuraAPI::API.settings[:developing])
